...
export const metadata = { title: 'Talk to Calmly AI' }
  ...
  return (
    <>
      <div className="page-head">
        <h1 className="page-title">Talk to Calmly AI</h1>
        <span className="page-meta">Private · between you and Calmly AI</span>
      </div>
