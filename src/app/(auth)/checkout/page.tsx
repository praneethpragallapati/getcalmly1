...
const plans: Record<PlanKey, {
  ...
  therapy: {
    ...
    summary: [
      ...
      { label: 'First session', value: '₹799' },
      { label: 'After that', value: 'Packs from ₹999 / session' },
      { label: 'Due today', value: '₹799' },
    ],
  ...
  psychiatry: {
    ...
    summary: [
      ...
      { label: 'First consultation', value: '₹999' },
      { label: 'After that', value: 'Packs from ₹1,199 / session' },
      { label: 'Due today', value: '₹999' },
    ],
    fineprint: 'You pay a flat ₹999 for your first consultation. Session packs unlock after it, and unused sessions are always refundable.',
