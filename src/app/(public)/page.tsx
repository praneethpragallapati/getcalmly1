...
export const metadata: Metadata = {
  ...
  description:
    'Book your first session for ₹799 with licensed therapists. AI-powered insights, daily mood tracking and a supportive community, matched to the right expert for you.',
