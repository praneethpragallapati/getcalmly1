...
const posts = [
  {
    ...
    content: [
      ...
      `Cognitive Behavioural Therapy gave me, and my clients, a language for this examination. The thought record — that deceptively simple tool of writing down the thought, the evidence for it, the evidence against it, and the more balanced conclusion — is where the distinction between anxiety and intuition often becomes visible. Anxiety tends to be absolute. It catastrophises. It picks evidence selectively. Intuition, when it is genuinely signal rather than noise, tends to be quieter, more specific, and not contingent on a worst-case outcome.`,
      ...
      `None of this means anxiety is untrustworthy. Sometimes the alarm is pointing at something real. But learning to distinguish between the two — between the mind protecting you and the mind terrorising you — is one of the most freeing skills I know. It is also one of the things therapy does best: it slows the loop down enough that you can actually look at what is inside it.`,
    ],
    related: [
      {
        title: 'I keep catastrophising at night — anyone else?',
        tags: ['anxiety'],
      },
      {
        title: 'How do you know when a gut feeling is worth trusting?',
        tags: ['self-awareness', 'anxiety'],
      },
      {
        title: 'My therapist introduced thought records and I found them really hard at first',
  ...
  },
  {
    ...
    content: [
      ...
      `If you are a new mother reading this: you are allowed to be struggling. The love can be real and the difficulty can also be real — these are not mutually exclusive. Please speak to your gynaecologist, your GP, or a perinatal mental health professional. Therapy works. Medication is safe during breastfeeding when indicated. You do not have to earn the right to help by suffering a particular amount first.`,
    ],
    related: [
      {
        title: 'Anyone else feel like they lost themselves after becoming a mother?',
        tags: ['postpartum', 'mothers-health'],
      },
      {
        title: 'Postpartum anxiety is real — sharing my experience',
        tags: ['postpartum', 'depression'],
      },
      {
        title: 'How do you tell family you are struggling without causing drama?',
        tags: ['mothers-health'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      `I also want to say this directly to the men: therapy is not a place where someone tells you what is wrong with you. It is not about reliving your childhood for decades. It is a practical space where you can think out loud with someone who has no agenda in your life. Most men I work with describe it, after a few months, as something between a useful debriefing and a physiotherapy session for the mind. It costs you time and money. It also returns to you things you did not know you had lost.`,
    ],
    related: [
      {
        title: 'I finally started therapy at 34 — why did I wait so long?',
        tags: ['men-mental-health', 'stigma'],
      },
      {
        title: 'How do I get my husband to take his mental health seriously?',
        tags: ['relationships', 'men-mental-health'],
      },
      {
        title: "Talking about feelings doesn't come naturally to me — is therapy still worth it?",
        tags: ['stigma', 'therapy'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      `I also want to be honest about what CBT is not. It is not a cure for everything. It does not work equally well for all presentations or all people, and recognising that early and finding a better fit is not failure — it is good clinical practice. Some clients need something more relational, more exploratory, more somatic. But for anxiety and depression in particular, the evidence for CBT is the best we have, and I have seen it change people's lives — not by making the hard things disappear, but by making those things easier to carry.`,
    ],
    related: [
      {
        title: 'CBT thought records feel weird — does it get easier?',
        tags: ['cbt', 'therapy'],
      },
      {
        title: 'How long before therapy actually starts working?',
        tags: ['therapy', 'anxiety', 'depression'],
      },
      {
        title: 'I missed all my CBT homework this week — is that bad?',
        tags: ['cbt', 'therapy'],
      },
    ],
  },
  {
    ...
    content: [
      ...
      `What therapy offers in grief is not acceleration. I want to be very clear about this: my job is not to help someone get through their grief faster. It is to offer accompaniment. A space in which the loss can be spoken, in which the complexity of grief — which is rarely pure sadness and often contains love, anger, relief, guilt, and tenderness in uncomfortable combination — can be held without judgement. Often the grief itself is not the problem. The isolation of carrying it alone is the problem.`,
      `If you are reading this in the middle of a loss: there is no right way to grieve. You do not have to "move on." You do not have to be stronger than you feel. You are allowed to be exactly where you are. And if the weight becomes too heavy to carry alone, reaching out is not weakness — it is one of the braver things you can do.`,
    ],
    related: [
      {
        title: 'It has been two years since I lost my father and I still cry at random moments',
        tags: ['grief', 'loss'],
      },
      {
        title: 'How do you grieve something that no one recognises as a real loss?',
        tags: ['grief', 'self-awareness'],
      },
      {
        title: 'Grief after a miscarriage — I feel like I am not allowed to talk about it',
        tags: ['grief', 'loss'],
      },
    ],
  },
