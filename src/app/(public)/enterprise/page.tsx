...
export default function EnterprisePage() {
  ...
  return (
    <div style={{ background: cream }}>
      ...
      {/* ─── HERO ─── */}
      <section style={{ background: 'radial-gradient(ellipse 65% 55% at 88% 8%, rgba(124,92,191,.30), transparent 55%), radial-gradient(ellipse 45% 50% at 4% 62%, rgba(200,85,61,.12), transparent 60%), #211C3D', minHeight: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '118px 48px 88px', position: 'relative', overflow: 'hidden' }}>
        <div style={{ position: 'absolute', top: -160, right: -120, width: 520, height: 520, borderRadius: '50%', background: 'radial-gradient(circle, rgba(124,92,191,.16) 0%, transparent 68%)', pointerEvents: 'none' }} />
      ...
      <section style={{ background: 'radial-gradient(ellipse 65% 55% at 88% 8%, rgba(124,92,191,.30), transparent 55%), radial-gradient(ellipse 45% 50% at 4% 62%, rgba(200,85,61,.12), transparent 60%), #211C3D', padding: '94px 48px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
