...
const ENT_FAQ: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: 'Confidential therapy and psychiatry with RCI- and NMC-verified clinicians, the Calm+ app for your team (mood check-ins, journaling, getCalmly AI), an anonymised dashboard for people leaders, and crisis resources built into the app.',
  },
  {
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 420px', gap: 80, alignItems: 'center', position: 'relative' }}>
          <div>
            ...
            <p style={{ fontSize: 18.5, color: 'rgba(255,255,255,.7)', lineHeight: 1.82, fontWeight: 300, maxWidth: 580, marginBottom: 38 }}>
              Burnout, absenteeism and quiet quitting are rarely loud. By the time they show up in your numbers, the cost is already paid. GetCalmly gives your people confidential therapy and psychiatry with RCI- and NMC-verified clinicians, and gives you the signal long before it becomes a statistic.
            </p>
        ...
        <div className="m-stack" style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '400px 1fr', gap: 72, alignItems: 'center' }}>
          ...
          <div>
            ...
            <p style={{ fontSize: 17, color: '#5A6B7A', lineHeight: 1.82, fontWeight: 300, marginBottom: 28 }}>
              One simple dashboard tells you whether your investment is working: how many people are engaging, where stress is rising, and whether wellbeing is trending up. The signal is drawn from everyday use of the app, mood check-ins, journaling and getCalmly AI conversations, then aggregated and anonymised, so you see the trend, never an individual&apos;s records.
            </p>
