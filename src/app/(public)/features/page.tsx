...
export default function FeaturesPage() {
  return (
    <div style={{ background: '#FFFCFA' }}>
      {/* Hero */}
      <section style={{ background: 'radial-gradient(ellipse 65% 55% at 88% 8%, rgba(31,182,168,.24), transparent 55%), radial-gradient(ellipse 45% 50% at 4% 62%, rgba(200,85,61,.14), transparent 60%), #0D2E2B', padding: '104px 24px 56px', position: 'relative', overflow: 'hidden' }}>
