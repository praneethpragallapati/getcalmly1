...
const services: Record<ServiceSlug, {
  ...
  therapy: {
    ...
    items: [
      ...
      { name: 'Stress & Burnout', desc: 'Work has taken over, your body is running on empty, and you\'ve forgotten what "okay" feels like.' },
    ...
    faq: [
      ...
      { q: 'Is this confidential?', a: 'Completely. What you say in the room stays in the room. The only exception is a serious safety concern, which your therapist will explain at the start. Your data is encrypted and handled under India\'s DPDP Act.' },
    ],
  ...
  couples: {
    ...
    items: [
      { name: 'Communication & Conflict', desc: 'The same fight on repeat, no matter the topic. Therapy helps you break the cycle and hear each other again.' },
    ...
    faq: [
      { q: 'How much does a session cost?', a: 'Your first one is ₹799. You\'ll see what each session after that costs in your dashboard before you book, so nothing sneaks up on you.' },
      { q: 'Are sessions online?', a: 'Yes, over video. You can sit together in one room, or join from two different places if that\'s easier. Both work fine.' },
  ...
  child: {
    ...
    items: [
      ...
      { name: 'Exam Stress', desc: 'The pressure to perform lands hard on students. We help them manage it rather than be crushed by it.' },
      ...
      { name: 'Behavioural Challenges', desc: 'Aggression, defiance, and outbursts are often a form of communication. Therapy helps decode them.' },
  ...
  maternal: {
    ...
    why: 'Our maternal mental health specialists are trained in perinatal care. They understand the hormonal, physical, and identity changes of pregnancy and postpartum, and the care is built for this exact season of life rather than generic therapy with a baby mentioned occasionally.',
    items: [
      ...
      { name: 'Postpartum Depression', desc: 'The sadness that doesn\'t lift, the disconnection from your baby or yourself. It\'s common, and it\'s very treatable.' },
      ...
      { name: 'Identity & Role Shift', desc: 'Grieving the person you were before, while becoming someone new. That tension is worth talking about.' },
    ...
    faq: [
      { q: 'How much does a session cost?', a: 'Your first one is ₹799, with someone who actually specialises in this period, not a generalist. You\'ll see the price of later sessions in your dashboard before you book.' },
      { q: 'Can I start during pregnancy, not just after birth?', a: 'Yes. You don\'t have to wait until after the birth. We\'re here through pregnancy, after birth, through fertility treatment, and through loss.' },
      { q: 'Are sessions online?', a: 'Yes, over video, from home. You can fit it around feeds, naps and your own recovery instead of getting anywhere.' },
  ...
  addiction: {
    ...
    faq: [
      { q: 'How much does it cost?', a: 'Your first session is ₹799, and it\'s completely private. You\'ll see what later sessions cost in your dashboard before you book.' },
      { q: 'Are sessions online?', a: 'Yes, and it stays private. There\'s no clinic to walk into, and nothing on a bill that gives away why you\'re here.' },
      { q: 'How do I start?', a: 'Book a first session, or take the free assessment if you\'d rather ease in. You don\'t have to call it anything, or wait until things get bad, to start.' },
  ...
  assessments: {
    ...
    why: 'Our assessments are administered by qualified clinical psychologists using validated tools. Reports are detailed, readable, and focused on what to do next.',
    items: [
      ...
      { name: 'Anxiety & Depression Screening', desc: 'Validated questionnaires with clinical interpretation: what the numbers mean for you, in plain language.' },
    ...
    faq: [
      { q: 'How much does an assessment cost?', a: 'It depends on which assessment and how long it takes. You\'ll see the price before you book, and your psychologist will talk you through what\'s involved first.' },
      { q: 'Are assessments done online?', a: 'Yes. A qualified clinical psychologist runs them online, using proper standardised tools rather than a quiz off the internet.' },
      { q: 'Can an assessment give me an official diagnosis?', a: 'Some can support a clinical diagnosis, others are more for understanding yourself. Your psychologist will tell you up front which is which for the one you\'re doing.' },
  ...
  specialised: {
    ...
    faq: [
      { q: 'How much does a session cost?', a: 'Your first one is ₹799, with someone trained for your specific situation. You\'ll see the price of later sessions in your dashboard before you book.' },
      { q: 'Are sessions online?', a: 'Yes, over video, so you can find the right specialist even if they aren\'t in your city.' },
      { q: 'How do I find the right specialist?', a: 'Tell us what you\'re dealing with in the assessment, or just book, and we\'ll point you to someone who works with exactly that. You won\'t have to explain your whole life from scratch.' },
        ...
        <div style={{ maxWidth: 1200, margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 380px', gap: 64, alignItems: 'flex-start' }}>
          <div>
            ...
            <p style={{ fontSize: 15.5, color: '#5A6A7A', lineHeight: 1.8, fontWeight: 300, marginTop: 18 }}>
              And the care doesn&apos;t stop when the session ends. The Calm+ app stays with you in between, daily mood check-ins, private journaling, and getCalmly AI whenever you need to talk things through, so your next session picks up right where you left off.
            </p>
          </div>
