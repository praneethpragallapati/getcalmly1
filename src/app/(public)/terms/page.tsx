...
export default function TermsPage() {
  return (
    <div style={{ background: '#F9F5F2' }}>
      <section style={{ background: 'radial-gradient(ellipse 65% 55% at 88% 8%, rgba(200,85,61,.28), transparent 55%), radial-gradient(ellipse 45% 50% at 4% 62%, rgba(200,85,61,.12), transparent 60%), #141E29', padding: '64px 24px 52px', textAlign: 'center' }}>
