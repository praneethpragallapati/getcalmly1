...
export default async function CommunityPostPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div style={{ background: '#FFFCFA', minHeight: '100vh' }}>
      {/* Header band */}
      <section className="hero-dark" style={{ background: 'radial-gradient(ellipse 65% 55% at 88% 8%, rgba(200,85,61,.28), transparent 55%), radial-gradient(ellipse 45% 50% at 4% 62%, rgba(200,85,61,.12), transparent 60%), #141E29', padding: '104px 24px 40px' }}>
