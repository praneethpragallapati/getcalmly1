// Country list for phone/dial-code selection. India is the default.
// Flag emoji is derived from the ISO code at render time (regional indicators),
// so we only store code, name and dial code here.

export type Country = { code: string; name: string; dial: string }

// India first (default), then the rest alphabetically by name.
...
/** Turn an ISO 3166-1 alpha-2 code into its flag emoji via regional indicators. */
