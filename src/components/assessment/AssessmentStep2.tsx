      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-8">
          ...
          <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
            <div className="h-full w-2/3 bg-[#0D5C63] rounded-full transition-all" />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4">
          {options.map((o) => (
            <button
              ...
              className="flex items-center gap-5 text-left bg-white border-2 border-transparent hover:border-[#0D5C63] rounded-2xl p-6 shadow-sm hover:shadow-lg transition group"
            >
        ...
        <button
          ...
          className="mt-8 text-sm text-gray-500 hover:text-[#0D5C63]"
        >
          ← Back
        </button>
      </div>
