...
<section class="features-section" id="features">
  ...
  <div class="feat-grid">
    ...
    <div class="feat-card reveal d1"><span class="feat-icon"><svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#A8432D" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3.5 20h17"/><rect x="6" y="5" width="12" height="15" rx="1.5"/><line x1="12" y1="8.4" x2="12" y2="12.4"/><line x1="10" y1="10.4" x2="14" y2="10.4"/><path d="M10 20v-3.4h4V20"/></svg></span><div class="feat-t">When therapy isn't enough, we don't ghost you</div><div class="feat-d">If you need more than sessions, getCalmly bridges you to hospital partners. Referral letters, session notes and progress reports, structured for a clean clinical handoff.</div><span class="feat-badge fb-c">Real backup</span></div>
