...
<section class="hiw-section" id="how-it-works">
  ...
  <div class="hiw-grid">
    ...
    <div class="hiw-step reveal d2"><div class="hiw-media" style="--img:url('/hiw/step-3.jpg')"></div><div class="hiw-line"></div><span class="hiw-n">3</span><h3>The intelligence between your sessions</h3><p>Calm AI finds patterns in your journey, spots emerging shifts in how you feel, and offers timely, personalised support when your clinician isn&apos;t there.</p><span class="hiw-tag">Context-aware AI</span></div>
