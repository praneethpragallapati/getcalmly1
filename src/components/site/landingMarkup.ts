...
<section class="testi-section">
  ...
  <div class="t3-grid" id="testi-track">
    ...
    <div class="testi-card reveal d2"><div class="stars">★★★★★</div><div class="testi-q">It&apos;s not a magic fix — I still have off days. But it helped me spot the pattern: my Sundays were quietly wrecking my whole week. Sounds like a small thing. Honestly just naming it made it manageable.</div><div class="testi-auth"><div class="testi-av" style="background:#EEF0FB;color:#7B7FCC;">A</div><div><div class="testi-nm">Aditya S., 26</div><div class="testi-dt">Design student · 2 months in</div></div></div></div>
