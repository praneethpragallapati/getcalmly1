...
<section class="hiw-section" id="how-it-works">
  ...
  <div class="hiw-grid">
    ...
    <div class="hiw-step reveal d2"><div class="hiw-media" style="--img:url('/hiw/step-3.jpg');background-position:center top"></div><span class="hiw-n">3</span><h3>Keep making progress between sessions</h3><p class="hiw-lead">Because your mental health doesn&apos;t pause when the session ends.</p><p>The more you use getCalmly, the better it understands you — spotting patterns in how you feel and offering timely, personalised support that meets you where you are. So even when your therapist isn&apos;t around, the right help is.</p></div>
