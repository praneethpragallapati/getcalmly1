...
<section class="hiw-section" id="how-it-works">
  ...
  <div class="hiw-grid">
    <div class="hiw-step reveal"><div class="hiw-media" style="--img:url('/hiw/step-1.jpg')"></div><div class="hiw-line"></div><span class="hiw-n">1</span><h3>Take the free assessment</h3><p>A few honest questions about how you&apos;ve really been — even at 3 a.m. In five minutes, get a clear read on the support that fits.</p><span class="hiw-tag">Free · 5 min</span></div>
    <div class="hiw-step reveal d1"><div class="hiw-media" style="--img:url('/hiw/step-2.jpg')"></div><div class="hiw-line"></div><span class="hiw-n">2</span><h3>Meet your match, book your session</h3><p>We pair you with a verified therapist or psychiatrist who truly gets it — then meet face to face, from ₹799.</p><span class="hiw-tag">First session from ₹799</span></div>
    <div class="hiw-step reveal d2"><div class="hiw-media" style="--img:url('/hiw/step-3.jpg');background-position:center top"></div><div class="hiw-line"></div><span class="hiw-n">3</span><h3>The intelligence between your sessions</h3><p>Calm AI learns your patterns — the heavy mornings, the big-meeting days — and offers timely, personal support when your clinician isn&apos;t there.</p><span class="hiw-tag">Context-aware AI</span></div>
    <div class="hiw-step reveal d3"><div class="hiw-media" style="--img:url('/hiw/step-4.jpg')"></div><span class="hiw-n">4</span><h3>Find the calm you came for</h3><p>Mood, journals and everyday guidance quietly add up — until calmer, lighter days aren&apos;t rare moments, but simply how life feels again.</p><span class="hiw-tag">A calmer you</span></div>
  </div>
</section>
