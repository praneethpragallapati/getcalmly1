...
<section class="hiw-section" id="how-it-works">
  ...
  <div class="hiw-grid">
    ...
    <div class="hiw-step reveal d2"><div class="hiw-media" style="--img:url('/hiw/step-3.jpg');background-position:center top"></div><span class="hiw-n">3</span><h3>Keep making progress between sessions</h3><p class="hiw-lead">Because your mental health doesn&apos;t pause when the session ends.</p><p>Use thoughtful tools, reflections and personalised support to stay connected to the work you&apos;re doing with your therapist. Small moments of awareness between sessions can help turn conversations into lasting change.</p></div>
