...
<section class="hiw-section" id="how-it-works">
  ...
  <div class="hiw-grid">
    <div class="hiw-step reveal"><div class="hiw-media" style="--img:url('/hiw/step-1.jpg')"></div><span class="hiw-n">1</span><h3>Understand where you are</h3><p class="hiw-lead">Start with a deeper understanding of what you&apos;re going through.</p><p>Share what&apos;s been on your mind, what&apos;s been difficult, and what you&apos;d like to change. Your assessment helps us understand your needs and match you with the right professional for you.</p></div>
    <div class="hiw-step reveal d1"><div class="hiw-media" style="--img:url('/hiw/step-2.jpg')"></div><span class="hiw-n">2</span><h3>Build your care with a therapist</h3><p class="hiw-lead">Meet regularly with a therapist who understands you.</p><p>Real progress takes time. Through regular one-on-one sessions, your therapist gets to know your experiences, helps you make sense of what you&apos;re feeling, and works with you towards meaningful goals.</p></div>
    <div class="hiw-step reveal d2"><div class="hiw-media" style="--img:url('/hiw/step-3.jpg');background-position:center top"></div><span class="hiw-n">3</span><h3>Keep making progress between sessions</h3><p class="hiw-lead">Because your mental health doesn&apos;t pause when the session ends.</p><p>Thoughtful tools and personalised support learn your patterns and get to know what helps you, so the right kind of care is there even when your therapist isn&apos;t. They keep you connected to the work you&apos;re doing together, turning small moments of awareness between sessions into lasting change.</p></div>
    <div class="hiw-step reveal d3"><div class="hiw-media" style="--img:url('/hiw/step-4.jpg')"></div><span class="hiw-n">4</span><h3>Find your calm</h3><p class="hiw-lead">Feel more equipped to navigate life, one step at a time.</p><p>With the right professional guidance and continued support, build a better understanding of yourself, develop healthier ways to cope, and move towards feeling more like yourself again.</p></div>
  </div>
</section>
