...
<section class="hero" id="home">
  ...
  <div class="hero-layout">
    ...
    <div class="hero-left">
      ...
      <p class="hero-sub">getCalmly matches you with the right therapist, understands your patterns with the world's first context-aware mental health AI, and stays with you from your very first session.</p>
...
<section class="how-section" id="how">
  <div class="sec-label reveal">Priya's story</div>
  ...
  <div class="how-layout">
    <div class="how-steps">
      ...
      <div class="how-step"><div class="hs-n">05</div><div><div class="hs-t">She felt better, and she saw why.</div><div class="hs-d">Sleep steadied. Mood climbed. And for the first time, the pattern was on a screen in front of her, not a weight she carried alone. That's what makes it last.</div><div class="hs-bar"><span></span></div></div></div>
    </div>
    <div class="how-visual reveal d1">
      ...
      <div class="how-card">
        ...
        <div class="hc-sub">A name for what she'd been carrying, and a match who could help.</div>
