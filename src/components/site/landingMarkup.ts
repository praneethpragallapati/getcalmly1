...
<section class="features-section" id="features">
  ...
  <div class="feat-grid">
    ...
    <div class="feat-card reveal d1"><span class="feat-icon"><svg width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="#A8432D" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="5"/><line x1="12" y1="9" x2="12" y2="15"/><line x1="9" y1="12" x2="15" y2="12"/></svg></span><div class="feat-t">When therapy isn't enough, we don't ghost you</div><div class="feat-d">If you need more than sessions, getCalmly bridges you to hospital partners. Referral letters, session notes and progress reports, structured for a clean clinical handoff.</div><span class="feat-badge fb-c">Real backup</span></div>
